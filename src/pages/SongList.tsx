...
export const SongList: React.FC = () => {
    ...
    const handleCreate = async () => {
        ...
        if (error) {
            ...
            alert('Failed to create song'); // Simple alert for now
        } else if (data) {
    ...
    return (
        <div className="min-h-screen bg-gray-950 text-white selection:bg-orange-500/30">
            ...
            <main className="max-w-7xl mx-auto p-6 space-y-8">
                ...
                {loading ? (
                    <div className="py-20 text-center text-gray-500">Loading your songs...</div>
                ) : (
                        ...
                        {songs.map(song => (
                            ...
                            >
                                <CardHeader className="pb-2">
                                    ...
                                    <CardTitle className="truncate mt-4 text-gray-100 group-hover:text-white">
                                        {song.title}
                                    </CardTitle>
                                </CardHeader>
                                <CardContent>
